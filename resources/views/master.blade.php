...
<body>
        ...
        {{-- <div class="header">
			<div class="header-left">
				<a href="index-2.html" class="logo">
					<img src="{{url('Backend/img/logo.png')}}" width="35" height="35" alt=""> <span>Preclinic</span>
				</a>
			</div>
            ...
            <ul class="nav user-menu float-right">
                ...
                <li class="nav-item dropdown has-arrow">
                    <a href="#" class="dropdown-toggle nav-link user-link" data-toggle="dropdown">
                        <span class="user-img">
							<img class="rounded-circle" src="{{url('Backend/img/user.jpg')}}" width="24" alt="Admin">
    ...
    <script src="{{url('Backend/js/Chart.bundle.js')}}"></script>
