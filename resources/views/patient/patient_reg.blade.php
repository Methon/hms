...
<hr>
<form method="post" action="{{route('patient.store.reg')}}">
  @csrf
        ...
        <div class="col-12 col-lg-9 col-xl-7">
          <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
            <div class="card-body p-4 p-md-5">
              ...
              <form action="{{route('patient.store.reg')}}" method="POST">
                @csrf
                <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 mb-4 pb-2">
                    ...
                    <div class="form-outline">
                      <input name="pnumber" type="tel" id="phoneNumber" class="form-control form-control-lg" />
            ...
            <div class="col-md-6 mb-4 pb-2">
              ...
              <div class="form-outline">
                <input name="address" type="tel" id="Address" class="form-control form-control-lg" />
